...
class VerticalAirflowAction : public Action<Ts...> {
 public:
  ...
  void play(Ts... x) override { this->parent_->set_vertical_airflow(this->direction_.value(x...)); }
...
class VerticalSwingDirectionAction : public Action<Ts...> {
 public:
  ...
  void play(Ts... x) override { this->parent_->set_vertical_swing_direction(this->direction_.value(x...)); }
...
class DisplayOnAction : public Action<Ts...> {
 public:
  ...
  void play(Ts... x) override { this->parent_->set_display_state(true); }
...
class DisplayOffAction : public Action<Ts...> {
 public:
  ...
  void play(Ts... x) override { this->parent_->set_display_state(false); }
...
class BeeperOnAction : public Action<Ts...> {
 public:
  ...
  void play(Ts... x) override { this->parent_->set_beeper_state(true); }
...
class BeeperOffAction : public Action<Ts...> {
 public:
  ...
  void play(Ts... x) override { this->parent_->set_beeper_state(false); }
...
template<typename... Ts>
class ModuleDisplayOnAction : public Action<Ts...> {
 public:
  ModuleDisplayOnAction(tclacClimate *parent) : parent_(parent) {}
  void play(Ts... x) override { this->parent_->set_module_display_state(true); }
...
template<typename... Ts>
class ModuleDisplayOffAction : public Action<Ts...> {
 public:
  ModuleDisplayOffAction(tclacClimate *parent) : parent_(parent) {}
  void play(Ts... x) override { this->parent_->set_module_display_state(false); }
...
template<typename... Ts>
class ForceOnAction : public Action<Ts...> {
 public:
  ForceOnAction(tclacClimate *parent) : parent_(parent) {}
  void play(Ts... x) override { this->parent_->set_force_mode_state(true); }
...
template<typename... Ts>
class ForceOffAction : public Action<Ts...> {
 public:
  ForceOffAction(tclacClimate *parent) : parent_(parent) {}
  void play(Ts... x) override { this->parent_->set_force_mode_state(false); }
